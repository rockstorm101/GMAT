...
#ifndef GEOMETRICMEAS_DEFS_HPP
#define GEOMETRICMEAS_DEFS_HPP
...
//#include "estimation_defs.hpp"
      ...
      #ifdef GEOMETRICMEAS_EXPORTS
         #define GEOMETRICMEAS_API __declspec(dllexport)
      #else
         #define GEOMETRICMEAS_API __declspec(dllimport)
      #endif
...
#ifndef GEOMETRICMEAS_API
   #define GEOMETRICMEAS_API
#endif

#endif // GEOMETRICMEAS_DEFS_HPP
