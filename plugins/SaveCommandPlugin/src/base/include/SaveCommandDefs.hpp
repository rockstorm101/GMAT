...
#include "gmatdefs.hpp"
      ...
      #ifdef SAVECOMMAND_EXPORTS
         #define SAVECOMMAND_API __declspec(dllexport)
      #else
         #define SAVECOMMAND_API __declspec(dllimport)
      #endif
...
#ifndef SAVECOMMAND_API
   #define SAVECOMMAND_API
#endif
