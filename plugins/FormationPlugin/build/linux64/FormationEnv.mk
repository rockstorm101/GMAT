# $Id$
# Linux environment settings for the Formation GMAT plugin
...
FORMATION_CPP_FLAGS = -fPIC
FORMATION_LINK_FLAGS = -fPIC
...
SHARED_EXTENSION = .so
SHARED_LIB_FLAGS = $(FORMATION_LINK_FLAGS) -shared -fPIC
...
CPP_BASE = $(OPTIMIZATIONS) $(FORMATION_CPP_FLAGS) -Wall \
