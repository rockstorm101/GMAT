...
DATAINTERFACE_CPP_FLAGS = -fPIC
DATAINTERFACE_LINK_FLAGS = -fPIC
...
SHARED_EXTENSION = .so
SHARED_LIB_FLAGS = $(DATAINTERFACE_LINK_FLAGS) -shared -fPIC
...
CPP_BASE = $(OPTIMIZATIONS) $(DATAINTERFACE_CPP_FLAGS) -Wall \
           $(PROFILE_FLAGS) $(DEBUG_FLAGS) -fPIC
