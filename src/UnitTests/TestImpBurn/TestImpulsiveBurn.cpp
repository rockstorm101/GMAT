 ...
 * 
 * Test Procedure:
 *   1. Create SolarSystem.
 *   2. Create FuelTank and set initial FuelMass.
 *   3. Create Spacecraft and set initial DryMass.
 *   4. Set FuelTank to Spacecraft.
 *   5. Create ImpulsiveBurn and set initial values.
 *   6. Set FuelTank to ImpulsiveBurn.
 *   7. Set SolarSystem to ImpulsiveBurn and initialize.
 *   8. Set the Spacecraft to ImpulsiveBurn to maneuver.
 *   9. Call Fire() on ImpulsiveBurn.
 *   10. Check if tank mass was decreased by expected amout.
 *
 * Validation method:
